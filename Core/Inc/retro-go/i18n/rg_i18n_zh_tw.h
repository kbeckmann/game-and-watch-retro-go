...
#define s_copy_RTC_to_GW_time   "從系統時間同步"
#define s_copy_GW_time_to_RTC   "同步時間到系統"
#define s_LCD_filter            "螢幕濾鏡"
#define s_Display_RAM           "顯示記憶體資訊"
#define s_Press_ACL             "重置遊戲" 
#define s_Press_TIME            "模擬 TIME  鍵 [B+TIME]"
#define s_Press_ALARM           "模擬 ALARM 鍵 [B+GAME]"
#define s_filter_0_none         "關"
...
#define s_Volume                "音量"
#define s_OptionsTit            "系統設定"
#define s_FPS                   "幀頻"
#define s_BUSY                  "負載（CPU）"
#define s_Scaling               "縮放"
#define s_SCalingOff            "關閉"
#define s_SCalingFit            "自動"
#define s_SCalingFull           "全螢幕"
#define s_SCalingCustom         "自訂"
#define s_Filtering             "濾鏡"
#define s_FilteringNone         "無"
#define s_FilteringOff          "關閉"
#define s_FilteringSharp        "銳利"
#define s_FilteringSoft         "柔和"
#define s_Speed                 "速度"
#define s_Speed_Unit            "倍"
#define s_Save_Cont             "■ 儲存進度"
#define s_Save_Quit             "▲ 儲存後退出"
#define s_Reload                "∞ 重新載入"
#define s_Options               "◎ 遊戲設定"
...
#define s_Theme_sList           "至簡列表"
#define s_Theme_CoverV          "垂直捲動"
#define s_Theme_CoverH          "水平捲動"
#define s_Theme_CoverLightV     "垂直滾動"
#define s_Theme_CoverLightH     "水平滾動"
//=====================================================================
...
#define s_Debug_menu                "∞ 調試選項"
#define s_Reset_settings            "≡ 恢復預設"
//#define s_Close                   "Close"
#define s_Retro_Go                  "關於 Retro-Go"
#define s_Confirm_Reset_settings    "您確定要恢復所有設定數據？"

#define s_Flash_JEDEC_ID            "存儲 JEDEC ID"
#define s_Flash_Name                "存儲晶片"
#define s_Flash_SR                  "存儲狀態"
#define s_Flash_CR                  "存儲配置"
#define s_Smallest_erase            "最小抹除單位"
#define s_DBGMCU_IDCODE             "DBGMCU IDCODE"
#define s_Enable_DBGMCU_CK          "開啟 DBGMCU CK"
#define s_Disable_DBGMCU_CK         "關閉 DBGMCU CK"
//#define s_Close                   "Close"
#define s_Debug_Title               "調試選項"
#define s_Idle_power_off            "省電待機"
#define s_Splash_Option             "啟動畫面"
#define s_Splash_On                 "開啟"
#define s_Splash_Off                "關閉"
